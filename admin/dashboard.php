...
?>
	...
	<head>
		...
		<title>Car Sales Management Portal | Admin Dashboard</title>
									...
									<div class="row">
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body text-dark" style="background-color: #FF9A76;">
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body" style='background-color: #8879B0;'>
													<div class="stat-panel text-center">
														<?php
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body" style='background-color: #A6CF98;'>
													<div class="stat-panel text-center">
														<?php
							...
							<div class="row">
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body" style="background-color:#E0DDAA;">
													<div class="stat-panel text-center">
														<?php
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body " style="background-color:#DFBB9D;">
													<div class="stat-panel text-center">
														<?php
