...
?>
	...
	<head>
		...
		<title>Car Sales Management Portal | Admin Edit Vehicle Info</title>
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {	?>
													...
													<form method="post" class="form-horizontal" enctype="multipart/form-data">
														...
														<div class="form-group">
															<label class="col-sm-2 control-label">Car Price(in PKR)<span style="color:red">*</span></label>
															<div class="col-sm-4">
											...
											<div class="form-group">
												...
												<div class="form-group">
													<div class="col-sm-8 col-sm-offset-2">
														...
														<button class="btn btn-primary" name="submit" type="submit" style="margin-top:5%">Save changes</button>
													</div>
												</div>
